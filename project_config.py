...
PROJECT_DIR = Path("/home/emirkan/projects/SHEPHERD") # Path('PATH/TO/SHEPHERD')
CURR_KG = '8.9.21_kg' 
...
MY_DATA_DIR = Path("/home/emirkan/projects/SHEPHERD/patients/mygene2_patients")
...
# MY_TEST_DATA = "/home/emirkan/projects/SHEPHERD/patients/mygene2_patients/mygene2_5.7.22.txt"
# MY_SPL_DATA = MY_DATA_DIR / "disease_split_all_sim_patients_kg_8.9.21_kg_agg=mean_spl_matrix.npy" # Result of data_prep/shortest_paths/add_spl_to_patients.py (suffix: _spl_matrix.npy)
# MY_SPL_INDEX_DATA = MY_DATA_DIR / "disease_split_all_sim_patients_kg_8.9.21_kg_spl_index_dict.pkl" # Result of data_prep/shortest_paths/add_spl_to_patients.py (suffix: _spl_index_dict.pkl)

# Head
MY_TEST_DATA = "/home/emirkan/projects/SHEPHERD/patients/mygene2_patients/mygene2_5.7.22_head.txt"
MY_SPL_DATA = MY_DATA_DIR / "mygene2_5.7.22_head_agg=mean_spl_matrix.npy" # Result of data_prep/shortest_paths/add_spl_to_patients.py (suffix: _spl_matrix.npy)
MY_SPL_INDEX_DATA = MY_DATA_DIR / "mygene2_5.7.22_head_spl_index_dict.pkl" # Result of data_prep/shortest_paths/add_spl_to_patients.py (suffix: _spl_index_dict.pkl)
